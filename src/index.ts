...
Сделано на стэке: express.js, typescript, typeorm

Чего не стал реализовывать: комплексный error handling в эндпоинтах и прочих функциях - не требовалось в тестовом
и заняло бы много времени, сложные типы TS также не стал создавать, так как только нахожусь в познании TS
и без ментора могу допустить оплошность, так что не удивляйтесь когда в некоторых местах увидите any
